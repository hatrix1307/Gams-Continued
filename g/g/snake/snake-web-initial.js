...
// Fill the viewport by default while preserving the game's square layout.
// This gives the same useful play area as the expanded view without requiring F.
const viewportFitStyle = document.createElement('style');
viewportFitStyle.textContent = `
  html, body {
    width: 100%;
    height: 100%;
    margin: 0;
...
`;
document.head.appendChild(viewportFitStyle);
