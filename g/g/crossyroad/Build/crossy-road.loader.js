function createUnityInstance(t, n, l) {
  ...
  u.SystemInfo = function() {
    ...
    var f, u = {
      ...
      "NT 6.3": "8.1",
      "NT 10.0": "10"
    }[u] || u, c = ((c = document.createElement("canvas")) && (f = (h = c.getContext("webgl2")) ? 2 : 0,
    ...
    function o() {
      return void 0 === e ? i.arrayBuffer().then(function(e) {
        ...
        if (e.done) {
          ...
          if (c < d)
            return f.slice(0, c);
          for (var t = new Uint8Array(c), n = (t.set(f, 0),
          h), r = 0; r < u.length; ++r)
            t.set(u[r], n),
            n += u[r].length;
          return t
        ...
        var t, n = {
          "inflate.js": function(e, t, n) {
            ...
            a.prototype.push = function(e, t) {
              var n, r, o, i, a, s = this.strm, l = this.options.chunkSize, d = this.options.dictionary, f = !1;
              if (this.ended)
                return !1;
              ...
              do {
                ...
                s.next_out = 0,
                s.avail_out = l),
                (n = u.inflate(s, b.Z_NO_FLUSH)) === b.Z_NEED_DICT && d && (a = "string" == typeof d ? h.string2buf(d) : "[object ArrayBuffer]" === m.call(d) ? new Uint8Array(d) : d,
                n = u.inflateSetDictionary(this.strm, a)),
                n === b.Z_BUF_ERROR && !0 === f && (n = b.Z_OK,
                f = !1),
                n !== b.Z_STREAM_END && n !== b.Z_OK)
                  return this.onEnd(n),
                  !(this.ended = !0)
              } while (!s.next_out || 0 !== s.avail_out && n !== b.Z_STREAM_END && (0 !== s.avail_in || r !== b.Z_FINISH && r !== b.Z_SYNC_FLUSH) || ("string" === this.options.to ? (a = h.utf8border(s.output, s.next_out),
              o = s.next_out - a,
              ...
              return (r = n === b.Z_STREAM_END ? b.Z_FINISH : r) === b.Z_FINISH ? (n = u.inflateEnd(this.strm),
              this.onEnd(n),
              this.ended = !0,
          ...
          "utils/strings.js": function(e, t, n) {
            ...
            n.string2buf = function(e) {
              for (var t, n, r, o, i = e.length, a = 0, s = 0; s < i; s++)
                55296 == (64512 & (n = e.charCodeAt(s))) && s + 1 < i && 56320 == (64512 & (r = e.charCodeAt(s + 1))) && (n = 65536 + (n - 55296 << 10) + (r - 56320),
                s++),
              ...
              for (var n, r, o = t || e.length, i = new Array(2 * o), a = 0, s = 0; s < o; )
                if ((n = e[s++]) < 128)
                  ...
                  for (n &= 2 === r ? 31 : 3 === r ? 15 : 7; 1 < r && s < o; )
                    n = n << 6 | 63 & e[s++],
                    r--;
                  1 < r ? i[a++] = 65533 : n < 65536 ? i[a++] = n : (n -= 65536,
                  i[a++] = 55296 | n >> 10 & 1023,
                  i[a++] = 56320 | 1023 & n)
                }
              return f(i, a)
          ...
          "zlib/inflate.js": function(e, t, n) {
            ...
            function l(e, t) {
              ...
              t = -t) : (n = 1 + (t >> 4),
              t < 48 && (t &= 15)),
              t && (t < 8 || 15 < t)) ? F : (null !== r.window && r.wbits !== t && (r.window = null),
              r.wrap = n,
              r.wbits = t,
              s(e))
            }
            ...
            function j(e, t, n, r) {
              ...
              r >= e.wsize ? (R.arraySet(e.window, t, n - e.wsize, e.wsize, 0),
              e.wnext = 0,
              e.whave = e.wsize) : (r < (o = e.wsize - e.wnext) && (o = r),
              R.arraySet(e.window, t, n - r, o, e.wnext),
              (r -= o) ? (R.arraySet(e.window, t, n - r, r, 0),
              e.wnext = r,
            ...
            n.inflate = function(e, t) {
              var n, r, o, i, a, s, l, d, f, u, c, h, b, m, g, w, p, v, k, y, _, x, S, E, C = 0, U = new R.Buf8(4), B = [16, 17, 18, 0, 8, 7, 9, 6, 10, 5, 11, 4, 12, 3, 13, 2, 14, 1, 15];
              ...
              e: for (; ; )
                ...
                case 7:
                  if (2048 & n.flags) {
                    ...
                    _ && h < s; )
                      ;
                    if (512 & n.flags && (n.check = O(n.check, r, h, i)),
                    s -= h,
                    i += h,
                    _)
                      break e
                ...
                case 13:
                  if (n.last)
                    ...
                    case 0:
                      ...
                      break;
                    case 1:
                      var L, L = T = void 0, T = n;
                      if (W) {
                        for (D = new R.Buf32(512),
                        H = new R.Buf32(32),
                        L = 0; L < 144; )
                          T.lens[L++] = 8;
                        for (; L < 256; )
                ...
                case 19:
                  for (; n.have < n.nlen + n.ndist; ) {
                    for (; w = (C = n.lencode[d & (1 << n.lenbits) - 1]) >>> 16 & 255,
                    p = 65535 & C,
                    !((g = C >>> 24) <= f); ) {
                      if (0 === s)
                        break e;
                  ...
                  x = P(1, n.lens, 0, n.nlen, n.lencode, 0, n.work, S),
                  n.lenbits = S.bits,
                  x) {
                  ...
                  x = P(2, n.lens, n.nlen, n.ndist, n.distcode, 0, n.work, S),
                  n.distbits = S.bits,
                  x) {
                ...
                case 21:
                  ...
                  for (n.back = 0; w = (C = n.lencode[d & (1 << n.lenbits) - 1]) >>> 16 & 255,
                  p = 65535 & C,
                  !((g = C >>> 24) <= f); ) {
                    if (0 === s)
                      break e;
                  ...
                  if (w && 0 == (240 & w)) {
                    for (v = g,
                    k = w,
                    y = p; w = (C = n.lencode[y + ((d & (1 << v + k) - 1) >> v)]) >>> 16 & 255,
                    p = 65535 & C,
                    !(v + (g = C >>> 24) <= f); ) {
                      if (0 === s)
                        break e;
                ...
                case 22:
                  ...
                  n.mode = 23;
                case 23:
                  for (; w = (C = n.distcode[d & (1 << n.distbits) - 1]) >>> 16 & 255,
                  p = 65535 & C,
                  !((g = C >>> 24) <= f); ) {
                    if (0 === s)
                      break e;
                  ...
                  if (0 == (240 & w)) {
                    for (v = g,
                    k = w,
                    y = p; w = (C = n.distcode[y + ((d & (1 << v + k) - 1) >> v)]) >>> 16 & 255,
                    p = 65535 & C,
                    !(v + (g = C >>> 24) <= f); ) {
                      if (0 === s)
                        break e;
                ...
                case 27:
                  if (n.wrap) {
                    ...
                    e.total_out += c,
                    n.total += c,
                    c && (e.adler = n.check = (n.flags ? O : A)(n.check, o, c, a - c)),
                    c = l,
              ...
              n.hold = d,
              n.bits = f,
              (n.wsize || c !== e.avail_out && n.mode < 30 && (n.mode < 27 || 4 !== t)) && j(e, e.output, e.next_out, c - e.avail_out) ? (n.mode = 31,
              -4) : (u -= e.avail_in,
              c -= e.avail_out,
              e.total_in += u,
              e.total_out += c,
              n.total += c,
              n.wrap && c && (e.adler = n.check = (n.flags ? O : A)(n.check, o, c, e.next_out - c)),
            ...
            n.inflateSetDictionary = function(e, t) {
              var n, r = t.length;
              return !e || !e.state || 0 !== (n = e.state).wrap && 11 !== n.mode ? F : 11 === n.mode && A(1, t, r, 0) !== n.check ? -3 : j(e, t, r, r) ? (n.mode = 31,
              -4) : (n.havedict = 1,
              z)
            }
            ,
          ...
          "zlib/adler32.js": function(e, t, n) {
            ...
            t.exports = function(e, t, n, r) {
              for (var o = 65535 & e | 0, i = e >>> 16 & 65535 | 0, a = 0; 0 !== n; ) {
                for (n -= a = 2e3 < n ? 2e3 : n; i = i + (o = o + t[r++] | 0) | 0,
                --a; )
                  ;
                o %= 65521,
                i %= 65521
          ...
          "zlib/inffast.js": function(e, t, n) {
            ...
            t.exports = function(e, t) {
              var n, r, o, i, a, s, l = e.state, d = e.next_in, f = e.input, u = d + (e.avail_in - 5), c = e.next_out, h = e.output, b = c - (t - e.avail_out), m = c + (e.avail_out - 257), g = l.dmax, w = l.wsize, p = l.whave, v = l.wnext, k = l.window, y = l.hold, _ = l.bits, x = l.lencode, S = l.distcode, E = (1 << l.lenbits) - 1, C = (1 << l.distbits) - 1;
              e: do {
                for (_ < 15 && (y += f[d++] << _,
                _ += 8,
                y += f[d++] << _,
          ...
          "zlib/inftrees.js": function(e, t, n) {
            ...
            t.exports = function(e, t, n, r, o, i, a, s) {
              for (var l, d, f, u, c, h, b, m, g, w = s.bits, p = 0, v = 0, k = 0, y = 0, _ = 0, x = 0, S = 0, E = 0, C = 0, U = 0, B = null, L = 0, T = new I.Buf16(16), R = new I.Buf16(16), A = null, O = 0, p = 0; p <= 15; p++)
                T[p] = 0;
              for (v = 0; v < r; v++)
                T[t[n + v]]++;
              for (_ = w,
              ...
              0 === y)
                ...
                for (; ; ) {
                  ...
                  0),
                  l = 1 << (b = p - S),
                  k = d = 1 << x; o[c + (U >> S) + (d -= l)] = b << 24 | m << 16 | g | 0,
                  0 !== d; )
                    ;
                  for (l = 1 << p - 1; U & l; )
                    l >>= 1;
                  ...
                  if (_ < p && (U & u) !== f) {
                    for (c += k,
                    E = 1 << (x = p - (S = 0 === S ? _ : S)); x + S < y && !((E -= T[x + S]) <= 0); )
                      x++,
                      E <<= 1;
                    if (C += 1 << x,
                    1 === e && 852 < C || 2 === e && 592 < C)
        ...
        try {
          for (var n in m) {
            ...
            if (m[n].hasUnityMarker(a))
              ...
              (r = m[n]).worker || (o = URL.createObjectURL(new Blob(["this.require = ", r.require.toString(), "; this.decompress = ", r.decompress.toString(), "; this.onmessage = ", function(e) {
                e = {
                  id: e.data.id,
  ...
  return new Promise(function(e, t) {
    u.SystemInfo.hasWebGL ? u.SystemInfo.hasWasm ? (1 == u.SystemInfo.hasWebGL && u.print('Warning: Your browser does not support "WebGL 2" Graphics API, switching to "WebGL 1"'),
